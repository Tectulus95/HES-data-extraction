...
def hamla():
    ...
    for i, filename in enumerate(filenames):
        ...
        df, name = hesDataExtraction.hamla_data_extraction(hesDirectory + filename)
...
def hes():
    ...
    for i, directory in enumerate(directories):
        ...
        hamdf, vildf, name = hesDataExtraction.hes_70_71_data_extraction(os.path.join(hesDirectory, directory))
